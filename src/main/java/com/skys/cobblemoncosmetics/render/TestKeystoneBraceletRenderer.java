...
/**
 * TEST CLASS - Renderer for the Test Keystone Bracelet
 * Positions the bracelet on the player's wrist/off-hand area
 *
 * REMOVE THIS FILE when testing is complete
 */
public class TestKeystoneBraceletRenderer implements AccessoryRenderer {
    @Override
    public <M extends LivingEntity> void render(
        ...
        if (handStack.getItem() instanceof com.skys.cobblemoncosmetics.items.TestKeystoneBracelet) {
            return;
        }
